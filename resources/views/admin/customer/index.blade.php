        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-info" href="{{ route('customer.edit',$customer->id) }}">
                  <i class="fas fa-edit"></i> Edit
                </a> 
                <a class="btn btn-danger text-light" onclick="deleteTag({{ $customer->id }})">
                ...
                <a class="btn btn-success text-light" data-toggle="modal" data-target="#modal-Item" >
