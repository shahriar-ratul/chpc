          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              {{-- <div class="card  card-outline card-info"> --}}
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('item.store') }}" method="POST" id="item-create">
                    @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="name">Item Code</label>
                      <input type="text" name="code" class="form-control" id="code" placeholder="Enter Item Code">
                    </div>                  
                  <div class="form-group">
                    ...
                    <div class="form-group pad">
                      ...
                      <textarea class="textarea" name="description"  id="description" placeholder="Enter Description here"
